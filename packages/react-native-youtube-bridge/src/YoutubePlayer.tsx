import { type MessageData, type PlayerControls, safeNumber, validateVideoId } from '@react-native-youtube-bridge/core';
...
import type { CommandType } from './types/message';
